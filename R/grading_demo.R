...
#' \code{check_code()} to check the single exercise in the tutorial. To use
#' \code{check_code()}, follow the exercise chunk with a chunk whose label
#' matches the label of the exercise chunk but includes the suffix
#' \code{-check}. Call \code{check_code()} in that chunk. To ensure that
#' \code{check_code()} can provide formative feedback, also provide the
