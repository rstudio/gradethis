...
This exercise depends on two objects defined in odd setup places:

1. `a` which is defined in the exercise set chunk
1. `b` which is defined in a chunk listed in the dependson option of the exercise setup chunk.

* Type `a + b`, then click Submit Answer.
