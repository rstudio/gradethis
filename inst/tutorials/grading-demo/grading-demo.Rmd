...
* Now, throw an error message of `"boom"`
...
The custom checking function should return the output of `gradethis::grade_feedback()` which takes two arguments:
