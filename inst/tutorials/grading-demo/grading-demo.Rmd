...
error_checker <- function(user_code, solution_code, ...) {
  list(
    correct = FALSE,
    message = paste0("I see you wrote '", user_code, "' but I was expecting '", solution_code, "'")
  )
}
...
tutorial_options(
  ...
  exercise.parse.checker = error_checker,
  exercise.error.checker = error_checker
)
...
To use the custom checking function, place it in an exercise `-check` chunk, as you would place `grade_result()`, `grade_conditions()`, or `grade_code()`.
