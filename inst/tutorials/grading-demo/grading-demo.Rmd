...
To use `gradethis` inside a [learnr](https://rstudio.github.io/learnr/) tutorial, we suggest calling `gradethis::enable_gradethis()` inside the tutorial's `setup` chunk. This is how it will look in the learnr R Markdown file:
...
In the case that you wish to provide custom checking logic for errors, you can also provide a `-error-check` chunk. 
